...
func init() {
	flag.StringVar(&binaryProg, "binary", "./../bin/ureprobe_app", "The path to the app binary to trace")
...
func main() {
	...
	uprobe, err := ex.Uretprobe(traceFn, objs.UretprobeDemoFunc, nil)
	if err != nil {
